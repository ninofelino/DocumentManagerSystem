...
public class Zdoc implements Serializable {
    ...
    @Size(max = 255)
    @Column(name = "NOMORDOCUMENT")
    private String nomordocument;
    @Size(max = 255)
    @Column(name = "NOTADCPERUBAHAN")
    private String notadcperubahan;
    @Size(max = 255)
    @Column(name = "NOTADCSOSIALISASI")
